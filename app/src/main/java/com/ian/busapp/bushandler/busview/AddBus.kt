...
class AddBus : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("bus")
        ...
        if (mImageUri != null) {
            ...
            mUploadTask = fileReference.putFile(mImageUri!!)
                .addOnSuccessListener { taskSnapshot ->
                    ...
                    Toast.makeText(
                        this@AddBus,
                        "Bus data Upload successful",
                        Toast.LENGTH_LONG
                    )
                        .show()
                    val upload = BusDataClass(
                        busreg = busnumberplateEt!!.text.toString().trim { it <= ' ' },
                        buscolor = buscolorEt!!.text.toString().trim { it <= ' ' },
                        busdriver = busDriverEt!!.text.toString().trim { it <= ' ' },
                ...
                .addOnFailureListener { e ->
                    progressBar.visibility = View.INVISIBLE
                    Toast.makeText(this@AddBus, e.message, Toast.LENGTH_SHORT).show()
    ...
    private fun  openImagesActivity() {
        startActivity(Intent(this@AddBus, BusHome::class.java))
    }
    }
